...
type EventHandlerMethod as function(byval _source_ent as any ptr, byval _event_data as any ptr) as long
...
type EventHandler 
    ...
    declare function trigger(byval src as any ptr, byval _event_data as any ptr) as long
